...
- **Nginx config:** `/etc/nginx/sites-available/opcp-ai-powered-store-dynamic`
- **Enabled symlink:** `/etc/nginx/sites-enabled/opcp-ai-powered-store-dynamic`
...
```bash
cat /etc/nginx/sites-available/opcp-ai-powered-store-dynamic
```
