...
**File**: `/home/ubuntu/opcp-ai-powered-store/scripts/postgresql_schema.sql`
...
### 2. Frontend Changes
**File**: `/home/ubuntu/opcp-ai-powered-store/templates/dashboard.html`
...
**File**: `/home/ubuntu/opcp-ai-powered-store/src/routes/orchestrator_routes.py`
...
**File**: `/home/ubuntu/opcp-ai-powered-store/src/orchestrator.py`
...
### 5. Migration Script
**File**: `/home/ubuntu/opcp-ai-powered-store/migration/add_user_id_to_services.sql`
...
psql -U swautomorph -d ai_swautomorph -f /home/ubuntu/opcp-ai-powered-store/migration/add_user_id_to_services.sql

# 2. Restart the application
sudo systemctl restart opcp-ai-powered-store
# OR
cd /home/ubuntu/opcp-ai-powered-store && ./deployControlPlan.sh restart
```
