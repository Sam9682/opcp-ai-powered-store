...
# OPCP-ai-powered-store Production Deployment Script
...
NAME_OF_APPLICATION=${NAME_OF_APPLICATION:-"opcp-ai-powered-store"}
...
server {
    ...
    ssl_certificate /home/ubuntu/opcp-ai-powered-store/ssl/${domain}/fullchain_domain.crt;
    ssl_certificate_key /home/ubuntu/opcp-ai-powered-store/ssl/${domain}/privateKey_domain.key;
...
help() {
    echo "🚀 OPCP-ai-powered-store Deployment Script v${VERSION}"
...
main() {
    ...
    case $COMMAND in
        ...
        "help"|"--help"|"-h")
            ...
            ;;
        "version"|"--version"|"-v")
            echo "OPCP-ai-powered-store v${VERSION}"
            exit 0
            ;;
        *)
